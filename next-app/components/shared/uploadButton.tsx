...
export function UploadButton({ onClick }: UploadButtonProps) {
    return (
        <div className="relative w-[235px] h-12 sm:h-16">
            ...
            <button
                className="absolute inset-0 bg-white rounded-lg border border-black z-10 flex items-center justify-center text-lg sm:text-2xl font-medium hover:bg-[#e5e5e5]"
                onClick={onClick}
            >
                upload
            </button>
