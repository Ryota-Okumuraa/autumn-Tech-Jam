    ...
    return (
        <main>
            ...
            <section className="md:pt-15 md:pb-12">
                ...
                {/* ページネーション */}
                <Pagenation currentPage={currentPage} totalPages={totalPages} basePath={`/posts/${category}`} />
            </section>
            <section className='mt-8 mb-20'>
                <div className='max-w-[960px] mx-auto px-4 flex flex-col gap-6'>
                    <QandA
                        question={t(`${category}.q1`)}
                        answer={t(`${category}.a1`)}
                    />
                    <QandA
                        question={t(`${category}.q2`)}
                        answer={t(`${category}.a2`)}
                    />
                    <QandA
                        question={t(`${category}.q3`)}
                        answer={t(`${category}.a3`)}
                    />
                </div>
            </section>
            <Footer />
