...
export const QandA = ({ question, answer }: Props) => {
    ...
    return (
        <div className="relative max-w-[960px] rounded-lg p-3 bg-main/60">
            <div className="rounded-lg border-2 border-black overflow-visible ">
                <button
                ...
                >
                    <div className="flex items-center">
                        <span className="w-12 h-12 shrink-0 flex items-center justify-center rounded-full bg-black text-white font-medium mr-4">Q</span>
