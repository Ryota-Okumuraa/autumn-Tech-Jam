            ...
            <div className="max-w-[1200px]">
                <div className="flex justify-between">
                    ...
                    <div className="h-12 relative w-[180px]">
                        <button
                            className="h-[45px] w-[175px] bg-white border-2 border-black rounded-sm text-black font-bold text-xl"
                ...
                <div className='md:flex md:flex-row-reverse md:gap-6 md:mt-10'>
                    ...
                    <div className='w-full border-r-2 border-black pr-6'>
                        <textarea className='w-full h-[500px] border-2 border-black rounded-lg bg-main p-4'>
                        </textarea>
                    </div>
                </div>
            </div>
