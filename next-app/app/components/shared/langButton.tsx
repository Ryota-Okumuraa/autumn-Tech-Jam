    ...
    <div className="relative inline-block">
      ...
      {isMenuOpen && (
        <div className="absolute top-full left-2 mt-2 p-1 w-40 bg-main border border-black rounded-xl shadow-lg z-20">
          <ul className="py-1">
            <li className="px-4 py-2 hover:bg-[#FFD933] border-b border-black last:border-b-0">中文（繁體）</li>
            <li className="px-4 py-2 hover:bg-[#FFD933] border-b border-black last:border-b-0">中文（简体）</li>
            <li className="px-4 py-2 hover:bg-[#FFD933] border-b border-black last:border-b-0">한국어</li>
            <li className="px-4 py-2 hover:bg-[#FFD933] border-b border-black last:border-b-0">日本語</li>
          </ul>
        </div>
      )}
    </div>
